...
//   const [loginError, setLoginError] = useState(''); // New state for backend errors
//   const navigate = useNavigate();

//   // Password validation (client-side, backend will also validate implicitly)
...
//           {loginError && <p className="mt-2 text-sm text-red-600 text-center">{loginError}</p>} {/* Display backend errors */}
...
//           <button
//             type="submit"
//             className="w-full flex justify-center py-3 px-4 rounded-md shadow-sm text-lg font-semibold
...
//       {/* Right Side: Testimonials & Companies */}
//       <div className="flex-1 hidden lg:flex flex-col items-center justify-center p-12 bg-gray-900 text-white overflow-hidden">
//         {/* Testimonials */}
//         {/* <div className="w-full max-w-sm max-h-10 overflow-hidden">
//           <h2 className="text-lg font-semibold text-white text-center mb-3">
//             Hear From Our Achievers
//           </h2>
//           <TestimonialSlider theme="dark" />
//         </div> */}


//         {/* Company Logos */}
//         <div className="w-full text-center">
//           <h2 className="text-2xl font-bold text-white-900">Companies</h2>
//           <p className="text-xl text-white-600 mt-4">Want to know the secret behind cracking the below company exams? </p>
//           <CompanyScroller direction="ltr" speed="medium" theme="dark" />
//           {/* <CompanyScroller direction="rtl" speed="medium" theme="dark" /> */}
//           {/* <CompanyScroller direction="ltr" speed="medium" theme="dark" /> */}
//         </div>

//         <section id="signup" className="py-20 bg-indigo-700 text-white text-center">
...
//           </p>
//           <Link to="/signup" className="bg-white text-indigo-700 hover:bg-indigo-50 font-bold text-lg px-10 py-5 rounded-full shadow-xl transform hover:scale-105 transition duration-300 ease-in-out">
//             Sign Up for Free
//           </Link>
//         </div>
//       </section>
...
// // import TestimonialSlider from '../common/TestimonialSlider'; // Adjusted path if needed
// import CompanyScroller from '../CompanyScroller'; // Adjusted path if needed
...
//         // Store user info in context and localStorage using the login function from AuthContext
//         login(data); // This now handles localStorage and state update

//         alert(`Login successful for ${data.name || data.email}!`); // Use data.name if available
...
//       {/* Right Side: Testimonials & Companies */}
//       <div className="flex-1 hidden lg:flex flex-col items-center justify-center p-12 bg-gray-900 text-white overflow-hidden">
//         {/* Testimonials - uncomment if you want to use it */}
//         {/* <div className="w-full max-w-sm max-h-10 overflow-hidden">
//           <h2 className="text-lg font-semibold text-white text-center mb-3">
//             Hear From Our Achievers
//           </h2>
...
//           <p className="text-xl text-gray-300 mt-4 mb-8">Want to know the secret behind cracking the below company exams? </p>
//           <CompanyScroller direction="ltr" speed="medium" theme="dark" />
//         </div>

//         <section id="signup" className="py-20 bg-indigo-700 text-white text-center mt-12"> {/* Added mt-12 for spacing */}
//           <div className="container mx-auto px-6">
//             <h2 className="text-4xl font-bold mb-6">Ready to Boost Your Career?</h2>
//             <p className="text-xl mb-10 max-w-3xl mx-auto">
//               Join thousands of students and alumni who are leveraging CampSync.AI to achieve their placement and academic goals.
